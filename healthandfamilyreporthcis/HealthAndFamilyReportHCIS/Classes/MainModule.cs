...
namespace HealthAndFamilyReportHCIS.Classes
{
    static class MainModule
    {
        //public static Department InstallLocation { get; set; }
        //public static Person PRS_SET { get; set; }
        //public static GivenServiceM GSM_Set { get; set; }

        static public Guid ServiceIdInDoor = Guid.Parse("d089b9fe-aa41-4416-86fd-937d18769900");
        static public int InDoorCategoryID = 3;
        static public int OutDoorCategoryID = 3;
        static public int WardCategoryID = 10;
        static public int AdmisionCategoryID = 4;
        static public int DentitsCategory = 7;
