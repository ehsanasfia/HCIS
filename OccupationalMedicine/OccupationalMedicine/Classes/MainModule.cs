...
namespace OccupationalMedicine.Classes
{
    public static class MainModule
    {
        public static OccupationalMedicineClassesDataContext dc { get; set; } = new OccupationalMedicineClassesDataContext();
        ...
        public static Visit Visit_Set { get; set; }
        public static String SelectedServer { get; set; }
        public static Contract DefaultContarct { get; set; }
