...
namespace SATAService
{
    ...
    {
        #region Connection Security and log
        const string Password = "ea!as()";
        public static void SetApplicationNameForConnectionString(string connectionName,bool SetPassword = true)
        {
            ...
            if(SetPassword) builder.Password = Password;
        ...
        //    }
        //}
        static private string userName = "مدیر سیستم";
        static public string UserName
        {
            get { return userName; }
            set { userName = value; }
        }
        static private string userFullName = "مدیر سیستم";
