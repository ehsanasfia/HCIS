...
using TeleComunication.Forms;

namespace TeleComunication
{
    public static class Program
    {
        ...
        public static void Main()
        {
            if (fromHCIS)
            {
                ...
                MainModule.SetApplicationNameForConnectionString("Transport");
            }
            else
            {
                DevExpress.XtraEditors.WindowsFormsSettings.DefaultFont = new Font("Tahoma", 9, FontStyle.Bold);
                ...
                if (diag.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MainModule.SetApplicationNameForConnectionString("TeleComunication");
