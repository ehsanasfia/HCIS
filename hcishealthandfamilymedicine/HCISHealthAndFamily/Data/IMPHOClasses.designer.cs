...
namespace HCISHealthAndFamily.Data
{
    ...
    partial void DeleteTbl_ValidCenterZone(Tbl_ValidCenterZone instance);
		...
		public IMPHOClassesDataContext() : 
				base(global::HCISHealthAndFamily.Properties.Settings.Default.IMPHOConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Member : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Person1> _Person;
    ...
    partial void OnCreationIPChanged();
		...
		public Member()
		{
			this._Person = default(EntityRef<Person1>);
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Person1_Member", Storage="_Person", ThisKey="IDPerson", OtherKey="IDPerson", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Person1 Person1
		{
			...
			set
			{
				Person1 previousValue = this._Person.Entity;
