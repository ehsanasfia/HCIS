namespace HCISInsurance.Dialogs
{
    partial class dlgChangeTariff
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.tariffsBindingSource.DataSource = typeof(HCISInsurance.Data.Tariff);
            // 
            // gridView1
            // 
            ...
            this.colDate.ColumnEdit = this.repositoryItemTextEdit4;
            ...
            this.repositoryItemTextEdit4.Mask.EditMask = "1[34][0-9][0-9]\\/((1[0-2])|(0[1-9]))\\/(([12][0-9])|(3[01])|0[1-9])";
