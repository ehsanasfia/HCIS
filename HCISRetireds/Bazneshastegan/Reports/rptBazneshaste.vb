...
Public Class rptBazneshaste
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bazneshastegan.rptBazneshaste.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBazneshaste
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBazneshaste = New rptBazneshaste()
        rpt.Site = Me.Site
        Return rpt
    End Function
