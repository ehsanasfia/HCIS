...
namespace HCISSecretary.Data
{
    ...
    partial void InsertArrivalsAndDeparture(ArrivalsAndDeparture instance);
    partial void UpdateArrivalsAndDeparture(ArrivalsAndDeparture instance);
    partial void DeleteArrivalsAndDeparture(ArrivalsAndDeparture instance);
    ...
    partial void DeleteStaff(Staff instance);
		...
		public HCISDataContext() : 
				base(global::HCISSecretary.Properties.Settings.Default.HCISConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<ArrivalsAndDeparture> ArrivalsAndDepartures
		{
			get
			{
				return this.GetTable<ArrivalsAndDeparture>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.ArrivalsAndDepartures")]
	public partial class ArrivalsAndDeparture : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _LastModifator;
    ...
    partial void OnDateChanging(string value);
    partial void OnDateChanged();
    partial void OnEnterTimeChanging(string value);
    ...
    partial void OnLastModifatorChanging(System.Nullable<int> value);
    partial void OnLastModifatorChanged();
    ...
    partial void OnLastModificationTimeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_EnterTime", DbType="NVarChar(8)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ExitTime", DbType="NVarChar(8)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LastModifator", DbType="Int")]
		public System.Nullable<int> LastModifator
		{
			get
			{
				return this._LastModifator;
			}
			set
			{
				if ((this._LastModifator != value))
				{
					this.OnLastModifatorChanging(value);
					this.SendPropertyChanging();
					this._LastModifator = value;
					this.SendPropertyChanged("LastModifator");
					this.OnLastModifatorChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Staff_ArrivalsAndDeparture", Storage="_Staff", ThisKey="StaffID", OtherKey="ID", IsForeignKey=true)]
		public Staff Staff
		{
			get
			{
			...
			set
			{
							...
							|| (this._Staff.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Staff.Entity = null;
						previousValue.ArrivalsAndDepartures.Remove(this);
					}
					this._Staff.Entity = value;
					if ((value != null))
					{
						value.ArrivalsAndDepartures.Add(this);
						this._StaffID = value.ID;
					}
					else
					{
	...
	public partial class Staff : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ArrivalsAndDeparture> _ArrivalsAndDepartures;
    ...
    partial void OnPositionIDChanged();
		...
		public Staff()
		{
			...
			this._DoctorInsurances = new EntitySet<DoctorInsurance>(new Action<DoctorInsurance>(this.attach_DoctorInsurances), new Action<DoctorInsurance>(this.detach_DoctorInsurances));
			this._Agendas = new EntitySet<Agenda>(new Action<Agenda>(this.attach_Agendas), new Action<Agenda>(this.detach_Agendas));
			this._ArrivalsAndDepartures = new EntitySet<ArrivalsAndDeparture>(new Action<ArrivalsAndDeparture>(this.attach_ArrivalsAndDepartures), new Action<ArrivalsAndDeparture>(this.detach_ArrivalsAndDepartures));
			this._References = new EntitySet<Reference>(new Action<Reference>(this.attach_References), new Action<Reference>(this.detach_References));
			this._TriageCPRs = new EntitySet<TriageCPR>(new Action<TriageCPR>(this.attach_TriageCPRs), new Action<TriageCPR>(this.detach_TriageCPRs));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Staff_ArrivalsAndDeparture", Storage="_ArrivalsAndDepartures", ThisKey="ID", OtherKey="StaffID")]
		public EntitySet<ArrivalsAndDeparture> ArrivalsAndDepartures
		{
			get
			{
				return this._ArrivalsAndDepartures;
			}
			set
			{
				this._ArrivalsAndDepartures.Assign(value);
			}
		}
		...
		private void attach_ArrivalsAndDepartures(ArrivalsAndDeparture entity)
		{
			this.SendPropertyChanging();
			entity.Staff = this;
		}
		
		private void detach_ArrivalsAndDepartures(ArrivalsAndDeparture entity)
		{
			this.SendPropertyChanging();
			entity.Staff = null;
		}
